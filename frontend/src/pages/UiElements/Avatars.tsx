...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | FMS - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for FMS - React.js Tailwind CSS Admin Dashboard Template"
      />
